...
const TIP_ACCOUNTS = [
  ...
  tokenInfo.devnet? new PublicKey('9ttgPBBhRYFuQccdR1DSnb7hydsWANoDsV3P9kaGMCEh'): TIP_ACCOUNTS[Math.floor(Math.random() * TIP_ACCOUNTS.length)];

const MERKEL_ROOT=new PublicKey('TiPUMdoBHXpARvH4WmLeT1SG5wc1dfZXKVZUkLCyY8L') 
    
export { config ,getRandomTipAccount,MERKEL_ROOT};